...
PROMPT_TEMPLATE = """Generate synthetic, simulated training data for a hypothetical POWERGRID-like project, parameterized by the reference name: "{project_name}".
The output is not factual project data and is intended only for ML model training and testing.


Your task:
- Use general domain heuristics derived from typical Indian transmission projects.
- Always populate all fields using synthetic but internally consistent values that obey the constraints below.
